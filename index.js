...
async function checkBalance() {
  await inquirer
    ...
    .then((res) => {
      ...
      console.log(chalk.bgBlue.white(`O saldo da sua conta e R$ ${balanceAccount}`))
...
function removeAmout(accountName, remove) {
  ...
  if (parseFloat(accountData.balance) - parseFloat(remove) > 0) {
    ...
    console.log(chalk.bgRed.black("Você não tem saldo o suficiente para realizar essa operação!"))
    return
  }
